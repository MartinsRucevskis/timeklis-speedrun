    ...
    <Template>
        <div class="container mx-auto min-w-full">
            <div class="grid grid-cols-1 md:grid-cols-8 gap-0 min-h-screen">
                <div class="section-2 md:col-span-3 bg-secondary-light shadow dark:bg-secondary-dark p-4 w-full">
                    {{translate('greet')}}
                </div>
                <div class="flex justify-center items-center section-3 md:col-span-4 bg-primary-light dark:bg-primary-dark p-4 w-full">
                    <YearCarousel />
                </div>
                <div class="section-1 justify-center bg-third-light dark:bg-third-dark p-1 w-full md:order-first grid auto-cols-max content-end">
                    <div class="flex">
                        ...
                        <SocialsIcon :color="'#0a66c2'" :svg="'M100.3 448H7.4V148.9h92.9zM53.8 108.1C24.1 108.1 0 83.5 0 53.8a53.8 53.8 0 0 1 107.6 0c0 29.7-24.1 54.3-53.8 54.3zM447.9 448h-92.7V302.4c0-34.7-.7-79.2-48.3-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z'"/>
                    </div>
                </div>
            </div>
        </div>
