    ...
    <Template>
        <div class="container mx-auto min-w-full">
            <div class="grid grid-cols-1 md:grid-cols-8 gap-0 min-h-screen">
                <div class="cool-shadow z-100 shadow-black text-center section-2 md:col-span-3 bg-secondary-light dark:bg-secondary-dark p-4 w-full">
                    <h3 class="md:pt-40 pt-10 mb-4 text-2xl font-bold leading-none tracking-tight md:text-3xl lg:text-4xl text-white">
                        {{translate('greet')}}
                    </h3>
                    <p class="align-middle text-3xl leading-relaxed dark:text-slate-300 text-slate-50 md:pt-20 md:pl-10 md:pr-10">{{translate('home_content')}}</p>
                </div>
                    <YearCarousel />
